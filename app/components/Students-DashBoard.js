...
import AchievementsModal from "./Student-achi/AchievementsModal";
...
export default function StudentsDashBoard({ regNo: propRegNo }) {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center text-center px-4 pt-10 overflow-hidden -mb-40 lg:items-end lg:text-end lg:pb-40 lg:pr-[10%]">
      ...
      {showAchievements && studentData?.regNo && (
        console.log("Opening AchievementsModal for regNo:", studentData.regNo),
        <AchievementsModal 
