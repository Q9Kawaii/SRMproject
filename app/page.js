              ...
              {isNewUser && newUserUID && (
                <div className="text-sm text-blue-600 mb-3 text-center">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <span className="w-40 overflow-hidden bg-neutral-200 rounded px-1">
                      <p className="font-mono bg-gray-100 px-3 py-1 rounded text-base text-blue-800">
                        {newUserUID}
                      </p>
                    </span>
                    <button
                  ...
                  <p className="mt-2">
                    ...
                    <span className="inline-flex items-center gap-2">
                      <span className="w-20 overflow-hidden bg-neutral-200 rounded px-1">
                        email@srmist.edu.in
                      </span>
                      <button
                        type="button"
  ...
  return (
    <div className="dashboard-container p-4">
      <div className="flex justify-end mb-4">
        <button onClick={handleLogout} className="bg-red-500 rounded text-white px-3 py-1">
          Logout
        </button>
      </div>
