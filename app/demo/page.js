...
// 1. Import 'db' and 'getDocs' (since your firebase.js exports them) from your local file.
import { db, getDocs } from "../../lib/firebase"; 

// 2. Import the missing utility functions from the standard Firebase SDK package.
//    (collection, query, and where were not exported from your local firebase.js)
...
export default function ProjectShowcase() {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            // ❌ FIXED: Removed 'const db = getDbInstance();'
            // The imported 'db' is used directly below.
            
            try {
                // 1. Fetch Total Users
                
                // Count from 'UsersLogin' collection (uses the imported 'db')
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
            ...
            {/* NEW: Live Admin Stats Block Integration */}
            <StatBlock />
